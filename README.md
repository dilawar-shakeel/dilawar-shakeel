...
║                                                                          ║
║   I build things that go past the notebook — multi-agent pipelines       ║
║   with guardrails, hybrid RAG with reranking, calibrated ML models       ║
║   with explainability, and everything served behind a FastAPI endpoint   ║
║   inside a Docker container.                                             ║
║                                                                          ║
║   My rule: if there's no endpoint, it's not finished.                    ║
║                                                                          ║
╚══════════════════════════════════════════════════════════════════════════╝
```
...
<p>
  ...
  <img src="https://img.shields.io/badge/Platt_Scaling-4B0082?style=for-the-badge&logoColor=white" />
